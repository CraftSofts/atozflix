...
type.addEventListener("change", function() {
  var div = document.getElementById("tv_series");
  var result = type.options[type.options.selectedIndex].value;
  if(result == "0") {
...
M.CharacterCounter.init(season);
var episode = document.getElementById("episode");
M.CharacterCounter.init(episode);